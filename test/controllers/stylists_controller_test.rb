...
class StylistsControllerTest < ActionController::TestCase
  ...
  test "should create stylist" do
    assert_difference('Stylist.count') do
      post :create, stylist: { clients: @stylist.clients, education: @stylist.education, equipment: @stylist.equipment, experience: @stylist.experience, rate: @stylist.rate, style: @stylist.style, user_id: @stylist.user_id }
    end
  ...
  test "should update stylist" do
    patch :update, id: @stylist, stylist: { clients: @stylist.clients, education: @stylist.education, equipment: @stylist.equipment, experience: @stylist.experience, rate: @stylist.rate, style: @stylist.style, user_id: @stylist.user_id }
    assert_redirected_to stylist_path(assigns(:stylist))
  end
